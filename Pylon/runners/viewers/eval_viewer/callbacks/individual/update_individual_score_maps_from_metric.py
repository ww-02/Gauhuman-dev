"""Update individual score maps when the metric dropdown changes."""
...
def register_individual_score_maps_from_metric_callback(
    app: Dash,
    ...
    def _update_individual_score_maps_from_metric(
        metric_name: Optional[str], epoch: Optional[int]
    ) -> List[html.Div]:
