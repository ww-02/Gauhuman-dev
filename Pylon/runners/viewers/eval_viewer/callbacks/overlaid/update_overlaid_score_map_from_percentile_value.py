"""Update the overlaid score map when the percentile value changes."""
...
def register_overlaid_score_map_from_percentile_value_callback(
    app: Dash,
    ...
    def _update_overlaid_score_map_from_percentile_value(
