"""Update the overlaid score map when the epoch slider changes."""
...
def register_overlaid_score_map_from_epoch_callback(
    app: Dash,
    ...
    def _update_overlaid_score_map_from_epoch(
        epoch: Optional[int],
